...
class GaussianProcess(UncertaintyAlgorithm):
    ...
    def __init__(self, **kwargs):
        ...
        self.dim = self.dataset.samples.shape[1]
        self.inducing = min(kwargs.get('inducing'), self.dataset.samples.shape[0])
    ...
    def predict_with_uncertainty(self, *args, **kwargs) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        model = GPy.models.SparseGPRegression(X, y, kern, normalizer=True,
                                              num_inducing=self.inducing)
